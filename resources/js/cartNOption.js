...
function message(data) {
    ...
    if (data == 'ok') {
        ...
        let theMessage = '<div class="alert alert-success alert-dismissible fade show" role="alert"><strong>Holy guacamole!</strong> You should check in on some of those fields below.<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>';
        alertMessage.innerHTML = theMessage;
    }
    if (data == 'nOk') {
        let alertMessage = document.querySelector('.alert');
        let theMessage = '<div class="alert alert-warning alert-dismissible fade show" role="alert"><strong>Holy guacamole!</strong> You should check in on some of those fields below.<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>';
        alertMessage.innerHTML = theMessage;
    }
...
function cartTotal(products, frete, field) {
    ...
    return field.innerHTML = `${totalPayment.toLocaleString('pt-BR', format)}`;
}