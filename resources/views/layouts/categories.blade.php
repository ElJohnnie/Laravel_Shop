...
<head>
	@foreach($categories as $c)
		<title>{{ $c->meta_tag_title }}</title>
		<meta charset="utf-8">
		<meta name="viewport" content="width=device-width, initial-scale=1.0">
		<meta name="description" content="{{ $c->meta_tag_description }}">
		<meta http-equiv="content-language" content="pt-br">
		<meta name="robots" content="index,follow">
		<meta name="author" content="JCODE - Soluções Web">
		<meta name="keywords" content="{{ $c->meta_tag_description }}">

		<meta property="og:type" content="website">
		<meta property="og:url" content="">
		<meta property="og:title" content="{{ $c->meta_tag_title }}">
		<meta property="og:image" content="{{ asset('img/bg.jpg') }}">
		<meta property="og:description" content="{{ $c->meta_tag_description }}">

		<meta name="twitter:card" content="summary">
		<meta name="twitter:site" content="@">
		<meta name="twitter:title" content="{{ $c->meta_tag_title }}">
		<meta name="twitter:creator" content="@">
		<meta name="twitter:description" content="{{ $c->meta_tag_description }}">
	@endforeach
	<!-- Favicon -->
