...
<div class="container">
	...
	<div class="progress mt-5 mb-5">
	  ...
	  <h2>Endereço de entrega do produto</h2>
	<div class="row">
		<div class="col-md-8">
			<form action="{{ route('checkout.set.shipping.address') }}" method="post">
				@csrf
				...
				<div class="card" style="margin-bottom: 5vw;">
					<div class="card-body">
						<button type="submit" class="site-btn sb-dark mt-1">Usar endereço selecionado para entrega</button>
					</div>
				</div>
				@endif
			</form>
