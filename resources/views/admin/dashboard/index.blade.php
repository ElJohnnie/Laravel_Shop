...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  ...
  <div class="container">
          ...
          <div class="col-xl-3 col-lg-6">
              <div class="card l-bg-cherry">
                  <div class="card-statistic-3 p-4">
                      <div class="mb-4">
                          <h5 class="card-title mb-0">Pedidos feitos</h5>
                      </div>
    ...
    <div class="col-md-12">
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="card">
            <div class="card-header" style="color:black;">
              <i class="fas fa-shopping-cart"></i> Produtos mais vendidos
            </div>
            <div class="card-body">
              <table class="table">
                <thead class="thead-dark">
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header" style="color:black;">
          <i class="fas fa-globe-americas"></i> Mapa de compras
        </div>
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="card">
                <div class="card-header" style="color:black;">
                  <i class="fas fa-question-circle"></i> Legenda
                </div>
                <div class="card-body">
                  <ul class="map-legend">
                    <li class="map-legend-1 p-4">
                      Poucas ou nada de vendas
                    </li>
                    <li class="map-legend-2 p-4">
                      Média vendas
                    </li>
                    <li class="map-legend-3 p-4">
                      Boas vendas
                    </li>
                    <li class="map-legend-4 p-4">
                      Ótimas vendas
                    </li>
                  </ul>
                </div>
