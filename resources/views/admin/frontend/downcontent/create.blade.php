    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body front-card">
                <form action="{{ route('admin.downcontent.store')}}" method="POST">
                    @csrf
                    <div class="form-row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="subtitle" class="form-control @error('subtitle') is-invalid @enderror" value="{{old('name')}}" required>
