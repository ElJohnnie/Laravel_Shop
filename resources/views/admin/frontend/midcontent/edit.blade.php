...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Atualizar conteúdo</h1>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header" style="color:black;">
                <i class="fas fa-desktop"></i> Atualizar conteúdo
            </div>
            <div class="card-body front-card">
                <form action="{{ route('admin.midcontent.update', ['midcontent' => $content->id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Tag</label>
                                <input type="text" name="tag" class="form-control @error('tag') is-invalid @enderror" value="{{$content->tag}}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @enderror
                                <img id="banner-preview" src="{{asset('storage/' . $content->image)}}" alt="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
