...
$(yAddress).change(function() {
    let yInputsAddress = '<div class="col-md-8 address-input"> <input name="street" value="' + userInformations.Address + '" type="text" placeholder="' + userInformations.Address + '" readonly> </div> <div class="col-md-4 address-input"> <input name="number" type="text" value="' + userInformations.Number + '" placeholder="' + userInformations.Number + '" readonly> </div> <div class="col-md-6 address-input"> <input name="district" value="' + userInformations.District + '" type="text" placeholder="' + userInformations.District + '" readonly> </div> <div class="col-md-6 address-input"> <input name="complement" value="' + userInformations.Complement + '" type="text" placeholder="Complemento"' + userInformations.Complement + '" readonly> </div> <div class="col-md-6 address-input"> <input name="city" value="' + userInformations.City + '" type="text" placeholder="' + userInformations.City + '" readonly> </div> <div class="col-md-3 address-input"> <input name="state" value="' + userInformations.State + '" type="text" placeholder="' + userInformations.State + '" readonly> </div> <div class="col-md-3 address-input"> <input name="country" value="' + userInformations.Country + '" type="text" placeholder="' + userInformations.Country + '" readonly> </div> <div class="col-md-6 address-input"><input name="cep" value="' + userInformations.CEP + '" type="text" placeholder="' + userInformations.CEP + '" readonly> </div> <div class="col-md-6 address-input"> <input name="contact" type="text" value="' + userInformations.Celfone + '" type="text" placeholder="' + userInformations.Celfone + '" readonly> </div>';
    if (this.checked) {
        ...
        $.ajax({
            ...
            success(res) {
                ...
                const billingInputs = '<div class="col-md-5"><form><div class="form-check"><input class="form-check-input" type="radio" name="billing" id="pac" value="' + PAC + '" data-billing="PAC"><label class="form-check-label" for="pac">PAC R$' + PAC + '</label></div><div class="form-check"><input class="form-check-input" type="radio" name="billing" id="sedex" value="' + sedex + '" data-billing="sedex"><label class="form-check-label" for="sedex">Sedex R$' + sedex + '</label></div></form></div>';
                ...
                let billingType = document.querySelectorAll('input[name=billing]');
                ...
                billingType.forEach(function(el, k) {
                    $(el).change(function() {
                        if (this.checked) {
                            ...
                            $('input[name=nome_cartao]').on("keyup", function() {
                                var texto = $(this).val();
                                Cardname.text(texto);
                            });
                            ...
                            function processPayment(token, paymentType, cpfInput, birthInput, celfoneCartaoInput) {
                                ...
                                $.ajax({
                                    ...
                                    success(res) {
                                        $('#modal').modal('hide');
                                        window.open(res.data.link_boleto, "Boleto da compra: " + res.data.order, "height=600,width=600");
